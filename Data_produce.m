...
for i = 1: size(x_observation, 1)
    ...
    for j = 1 : size(model_z_up, 1)
        [Hax_temp, Za_temp, Delta_T_temp] = magnetic_froward_2D(x_observation(i), z_observation, ...
...
[Hax_vector, Za_vector,Delta_vector]  = magnetic_froward_2D(x_observation, z_observation, ...
